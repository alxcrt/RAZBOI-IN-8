...
std::unordered_map<std::string, std::array<std::string, 3>> dict{
    ...
    {"Player vs Jev", {"Player vs Jev", "Joueur contre Jev", "Jucator contra Jev"}},
    ...
    {"Jev is thinking...", {"Jev is thinking...", "Jev reflechit...", "Jev se gandeste..."}},
    {"Jev took a Dokter!", {"Jev took a Dokter!", "Jev a pris un Docteur!", "Jev a luat un Doctor!"}},
    {"Jev set a trap", {"Jev set a trap", "Jev tend un piege", "Jev a intins o capcana"}},
    {"Jev played safe", {"Jev played safe", "Jev joue prudent", "Jev a jucat sigur"}},
    {"Jev took a risk", {"Jev took a risk", "Jev prend un risque", "Jev a riscat"}},
    {"Jev is offline", {"Jev is offline", "Jev est hors ligne", "Jev e offline"}},
    {"random move", {"random move", "coup au hasard", "mutare la intamplare"}},
    {"Jev was sure", {"Jev was sure", "Jev etait sur", "Jev a fost sigur"}},
    {"Jev hesitated", {"Jev hesitated", "Jev a hesite", "Jev a ezitat"}},
    {"take", {"take", "prise", "captura"}},
    {"trap", {"trap", "piege", "capcana"}},
    {"safe", {"safe", "prudent", "sigur"}},
    {"risky", {"risky", "risque", "risc"}},
